...
export default function Footer() {
  ...
  const contactInfo = [
    { icon: Icons.Phone, text: '+373 60 179 539', color: '#4CD0DC' },
    { icon: Icons.Mail, text: 'eduqo.afterschool@gmail.com', color: '#FC0168' },
    { icon: Icons.Location, text: 'Durlești, str. Cartușa 83, et. 2', color: '#2BA84C' },
    { icon: Icons.Clock, text: 'Luni-Vineri: 9:00-19:00', color: '#FCD700' },
  ]

  const socialLinks = [
    { 
      name: 'Facebook', 
      href: 'https://www.facebook.com/share/1FNwYERQTt/', 
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    { 
      name: 'Instagram', 
      href: 'https://www.instagram.com/eduqo_afterschool', 
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
